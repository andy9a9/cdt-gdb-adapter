...
export abstract class GDBDebugSessionBase extends LoggingDebugSession {
    ...
    protected async threadsRequest(
        ...
        try {
            ...
            // The pollThreadInfo setting controls when thread info is retrieved:
            ...
            // - 'when-requested': Thread info is retrieved when client requests it (when stopped
            //   or when allowed while running)
            // - 'never': Thread info is never retrieved, cached data is used
